...
const CURVE_PATH =
  "M3.61588 7.13622C252.484 133.236 376.917 328.836 584.585 342.569C790.649 356.197 1098.55 120.334 1321.62 48.7532";
...
const getIconForTitle = (title: string): LucideIcon => {
  ...
  if (titleLower.includes("rigorous") || titleLower.includes("inspection"))
    return ClipboardCheck;
  if (titleLower.includes("quality")) return Award;
  if (titleLower.includes("safety") || titleLower.includes("comfort"))
    return Shield;
  if (titleLower.includes("innovation")) return Lightbulb;
  if (titleLower.includes("custom")) return Settings;
  if (titleLower.includes("precision") || titleLower.includes("machining"))
    return Gauge;
  if (titleLower.includes("sustainab") || titleLower.includes("cost"))
    return Leaf;
  if (titleLower.includes("global") || titleLower.includes("partnership"))
    return Globe;
      ...
      <div className="lg:hidden relative min-h-[500px] py-6">
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #756F3F 0%, transparent 100%)",
            }}
          />
          {backgroundImage && (
            <div className="absolute inset-0">
        ...
        <div className="relative px-6">
          ...
          <div className="text-center mb-5">
            <h1
              className="font-anaheim font-extrabold text-[32px] leading-[38px] text-white"
            ...
            <div className="flex flex-col p-4 gap-2.5">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1.5">
                  {(() => {
                    const IconComponent = getIconForTitle(
                      activeSlide?.title || "",
                    );
                    return (
                      <IconComponent
      ...
      <div className="hidden lg:block relative w-full h-full">
        ...
        {pathPoints.length > 0 &&
          slides.map((slide, slideIndex) => {
            ...
            const shouldBeLarge =
              isActive &&
              (animationPhase === "idle" || animationPhase === "grow");
        ...
        >
          ...
          <button
            onClick={handlePrev}
            disabled={isAnimating}
            className="group border-2 border-[#756F3F] bg-transparent hover:bg-[#756F3F] hover:scale-110 flex items-center justify-center transition-all disabled:opacity-50"
            style={{
              width: vw(74),
              height: vw(74),
              borderRadius: vw(37),
