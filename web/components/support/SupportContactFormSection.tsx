  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        >
          <svg
            width="100%"
            height="100%"
            viewBox="0 0 24.576 49.088"
            fill="none"
            preserveAspectRatio="none"
          >
            <path
              d="M24.576 0c-3.02933 8.192-6.05867 16.384-9.088 24.576-2.98667 8.14933-5.99467 16.32-9.024 24.51201l-6.464 0c3.02933-8.192 6.03733-16.36267 9.024-24.51201 3.02933-8.192 6.05867-16.384 9.088-24.576l6.464 0z"
              fill="#FFE83C"
            />
          </svg>
        </div>
        ...
        <div
          ...
          style={{ left: vw(153), top: vw(177), width: vw(863) }}
        >
          <h2
          ...
          <p
            className="text-white normal-case text-left"
            style={{
      ...
      <div
        ...
        style={{ marginLeft: vw(1289), marginTop: vw(91), width: vw(486) }}
      >
        <form
          ref={formRef}
        ...
        >
          ...
          <div className="flex justify-end pr-4">
            <label
              className="flex items-center cursor-pointer border border-[#756F3F] rounded-full px-6 py-2 transition-colors hover:bg-black/10"
          ...
          {mergedConfig?.privacyConsentText && (
            ...
            >
              ...
              <p className="text-xs leading-relaxed text-white/70 select-none text-left whitespace-pre-line">
