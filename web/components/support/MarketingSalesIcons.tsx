...
export const MarketingSalesNextBtn = ({ onClick, disabled, size = "83px" }: { onClick: () => void; disabled?: boolean; size?: string }) => {
  return (
    <motion.button
      ...
      onClick={onClick}
      disabled={disabled}
      className="focus:outline-none transition-opacity disabled:opacity-30 flex items-center justify-center rounded-full"
      style={{ width: size, height: size }}
    >
      <svg width="100%" height="100%" viewBox="0 0 83 82" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M41.5 0C64.4198 0 83 18.3563 83 41C83 63.6437 64.4198 82 41.5 82C18.5802 82 0 63.6437 0 41C0 18.3563 18.5802 0 41.5 0ZM32.0723 27.5225L45.6885 41.0566L32.0723 54.5918L34.3916 56.9551L50.5869 41.0566L34.3916 25.1592L32.0723 27.5225Z" fill="white"/>
      </svg>
    </motion.button>
  )
}
...
export const MarketingSalesPrevBtn = ({ onClick, disabled, size = "83px" }: { onClick: () => void; disabled?: boolean; size?: string }) => {
  return (
    ...
    >
      <svg width="100%" height="100%" viewBox="0 0 83 82" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="41.5" cy="41" r="40.5" stroke="white" strokeWidth="1" />
