...
const rpx = (designValue: number) =>
  `calc(var(--rpx-odm-product-series) * ${designValue})`;
...
const defaultContent = {
  ...
  description:
    "We offer a full-process ODM solution for glass hardware from design and development to production and delivery, helping you efficiently create differentiated products. Its main products include",
};
        ...
        >
          ...
          >
            <Link
              ...
              style={{ gap: rpx(16) }}
            >
              <AnimatedLinkButton ballColor="#9d946e">
          ...
          <motion.div
            ...
            style={{
              ...
              color: "#595429",
              scrollbarWidth: 'thin',
              scrollbarColor: 'rgba(89, 84, 41, 0.3) transparent',
      ...
      <div className="block md:hidden px-5 py-8">
        ...
        <div className="relative w-full h-[280px]">
          ...
          <svg className="absolute" style={{ width: 0, height: 0 }}>
            <defs>
              <clipPath
                id="odmProductSeriesClipPathMobile"
                clipPathUnits="objectBoundingBox"
              >
                <path
                  transform="scale(0.0008993, 0.001965)"
