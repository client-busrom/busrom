...
const rpx = (designValue: number) =>
  `calc(var(--rpx-odm-service-intro) * ${designValue})`;
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{
                  ...
                  lineHeight: rpx(53), // 75 * 0.7
                  backgroundImage:
                    "linear-gradient(180deg, #59542A 0%, rgba(89,84,42,0) 100%)",
      ...
      <div className="block md:hidden px-5 py-10">
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(180deg, #59542A 0%, rgba(89,84,42,0.3) 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}
          >
