    ...
    >
      ...
      <div className="hidden md:block relative w-full" style={{ height: rpx(DESIGN_HEIGHT) }}>
        ...
        >
          ...
          <motion.div
            className="absolute font-anaheim font-semibold text-white text-right overflow-x-auto overflow-y-hidden"
            style={{
              left: rpx(630), // 1271 * 0.7
              top: rpx(171), // 244 * 0.7
              width: rpx(600), // 486 * 0.7
              maxHeight: rpx(45), // 限制最大高度
              ...
              paddingBottom: rpx(6), // 给横向滚动条留出一点空间
            }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <div className="block md:hidden px-5 py-8">
        ...
        >
          <div
            className="font-anaheim font-semibold text-white text-lg mb-2 overflow-x-auto overflow-y-hidden whitespace-nowrap"
            style={{
              maxHeight: "2.5rem",
              scrollbarWidth: "thin",
              scrollbarColor: "rgba(255,255,255,0.3) transparent",
