  ...
  if (loading) {
    return (
      <section
        ...
        style={{ ["--rpx-applications" as string]: `calc(100vw / ${DESIGN_WIDTH})` }}
      >
        <div className="hidden md:flex relative w-full items-center justify-center bg-[#D9D9D9]" style={{ height: rpx(1086) }}>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <path d="M77.3663 116.717C77.4784 116.911 77.6281 117.081 77.8069 117.217C77.9857 117.353 78.19 117.452 78.4083 117.509C78.6265 117.566 78.8544 117.58 79.0789 117.55C79.3034 117.519 79.5202 117.445 79.7167 117.331L124.669 91.3784L120.62 106.12C120.499 106.56 120.559 107.027 120.785 107.419C121.011 107.811 121.386 108.096 121.827 108.211C122.268 108.326 122.739 108.262 123.136 108.033C123.533 107.804 123.824 107.428 123.944 106.989L129.091 88.248C129.151 88.0304 129.167 87.8038 129.139 87.5809C129.11 87.3581 129.038 87.1435 128.926 86.9493C128.814 86.7551 128.664 86.5852 128.485 86.4493C128.306 86.3133 128.102 86.214 127.884 86.157L109.08 81.2437C108.862 81.1866 108.634 81.173 108.409 81.2036C108.185 81.2341 107.968 81.3083 107.772 81.4218C107.575 81.5353 107.402 81.6859 107.264 81.8651C107.125 82.0443 107.023 82.2485 106.963 82.466C106.903 82.6836 106.887 82.9102 106.915 83.1331C106.944 83.3559 107.016 83.5705 107.128 83.7647C107.24 83.9588 107.39 84.1288 107.569 84.2647C107.748 84.4007 107.952 84.5 108.17 84.557L122.962 88.4216L78.0096 114.375C77.8131 114.488 77.6405 114.639 77.5018 114.818C77.3631 114.997 77.2609 115.201 77.2012 115.419C77.1414 115.636 77.1253 115.863 77.1536 116.086C77.1819 116.308 77.2542 116.523 77.3663 116.717Z" fill="white"/>
            <circle cx="102.315" cy="102.315" r="74.8999" transform="rotate(-120 102.315 102.315)" stroke="white" strokeWidth="2"/>
          </motion.svg>
          <span
        ...
        <div className="relative w-full aspect-[16/10]">
          ...
          >
            ...
            <svg width="10" height="18" viewBox="0 0 16 31" fill="none">
              <path d="M1 1L14 15.5L1 30" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        </div>
      </div>
