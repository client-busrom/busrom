        ...
        <div className="bg-white rounded-[30px] border border-[#cfcaa2] overflow-hidden shadow-sm flex flex-col">
          ...
          >
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {textFields.map((field, idx) => {
                  ...
                  return (
                    <div
                      key={field.fieldName}
                      className="bg-[#F3F1EA] rounded-2xl border border-white/34 h-14 flex items-center"
                    >
                      {isPhone ? (
                        <PhoneInput
                          id={field.fieldName}
              ...
              {selectFields[0] && (
                <div className="space-y-4">
                  ...
                  <div className="relative bg-[#F3F1EA] rounded-2xl border border-white/34 h-14">
                    <select
              ...
              {/* Textarea */}
              {textareaFields[0] && (
                <div className="bg-[#F3F1EA] rounded-2xl border border-white/34 p-5 min-h-[80px]">
                  <textarea
              ...
              <div className="flex flex-col gap-0 pt-2">
                ...
                {/* Turnstile & Submit */}
                <div className="flex flex-col md:flex-row items-center justify-end gap-8 mt-4 md:mt-0">
                  {turnstileSiteKey && (
                    <Turnstile
                      key={turnstileKey}
                  ...
                  <motion.button
                    type="submit"
                    disabled={submitting || (!!privacyText && !privacyAccepted)}
            ...
            <div className="lg:col-span-4 h-fit">
              {checkboxFields[0] && (
                <div className="bg-[#FBF6E4] rounded-[30px] p-8 md:p-12 space-y-8 border border-white/34 shadow-sm">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#6F6200] leading-tight">
                  ...
                  {(formData[checkboxFields[0].fieldName] || []).some(
                    ...
                    <div className="pt-4">
                      <textarea
                        ...
                        className="w-full bg-[#F4EDD4] rounded-xl p-4 text-base text-[#6F6200] outline-none border border-transparent focus:border-[#6F6200]/20 min-h-[100px]"
