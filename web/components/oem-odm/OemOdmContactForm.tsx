...
const rpx = (designValue: number) =>
  `calc(var(--rpx-contact-form) * ${designValue * SCALE})`;
...
export function OemOdmContactForm({
  ...
  const containerHeight = hasPrivacyText ? 1357 : 1257;
  const innerHeight = hasPrivacyText ? 1300 : 1200;
  const captchaTop = hasPrivacyText ? 1080 : 980;
  const submitTop = hasPrivacyText ? 1100 : 1000;
              ...
              if (uploadedFiles.length === 1) {
                ...
                setUploadProgress((prev) => {
                  return Math.max(
                    prev,
                    Math.round(
                      (index / uploadedFiles.length) * 100 +
                        event.percent / uploadedFiles.length,
                    ),
                  );
                });
              }
  ...
  if (!formConfig || fields.length === 0) {
    return (
      <section
        ...
        style={{
          ["--rpx-contact-form" as string]: `calc(100vw / ${DESIGN_WIDTH})`,
        }}
      >
        <div
          className="hidden md:flex relative w-full items-center justify-center"
          style={{ height: rpx(1257) }}
        >
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
            <p className="text-yellow-700">
              {configData?.formErrorMessage || ""}
            </p>
          </div>
        </div>
      </section>
  ...
  return (
    <section
      className="relative w-full overflow-hidden transition-all duration-500 ease-in-out py-[60px]"
      style={{
        ["--rpx-contact-form" as string]: `calc(100vw / ${DESIGN_WIDTH})`,
      }}
    >
      {/* ========== PC端布局 ========== */}
      <div
        className="hidden md:block relative w-full transition-all duration-500 ease-in-out"
        style={{ height: rpx(containerHeight) }}
      >
        {/* 居中容器 */}
        <div
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleChange(textFields[0]?.fieldName, e.target.value)
                }
                ...
                placeholder={
                  textFields[0]?.placeholder || textFields[0]?.label || ""
                }
                disabled={submitting}
              />
            </div>
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleChange(textFields[1]?.fieldName, e.target.value)
                }
                className="w-full h-full font-anaheim font-semibold outline-none bg-transparent"
                style={{
                  paddingLeft: rpx(29),
                ...
                placeholder={
                  textFields[1]?.placeholder || textFields[1]?.label || ""
                }
                disabled={submitting}
              />
            </div>
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleChange(textFields[2]?.fieldName, e.target.value)
                }
                className="w-full h-full font-anaheim font-semibold outline-none bg-transparent"
                style={{
                  paddingLeft: rpx(29),
                ...
                placeholder={
                  textFields[2]?.placeholder || textFields[2]?.label || ""
                }
                disabled={submitting}
              />
            </div>
            ...
            >
              <PhoneInput
                ...
                onChange={(phone) =>
                  handleChange(textFields[3]?.fieldName, phone)
                }
                placeholder={
                  textFields[3]?.placeholder || textFields[3]?.label || ""
                }
                disabled={submitting}
            ...
            >
              {selectFields[0]?.label ||
                "The Type Of Cooperation You are Interested In"}
            </span>
            ...
            >
              <select
                ...
                onChange={(e) =>
                  handleChange(selectFields[0]?.fieldName, e.target.value)
                }
            ...
            >
              <textarea
                ...
                onChange={(e) =>
                  handleChange(textareaFields[0]?.fieldName, e.target.value)
                }
            ...
            {/* 上传文件按钮 */}
            <div
              className="absolute flex items-center justify-center cursor-pointer whitespace-nowrap text-[#756F3F] hover:bg-[#756F3F] hover:text-white transition-all group"
              style={{
                left: rpx(141),
                top: rpx(932),
                width: rpx(248),
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: rpx(24), color: "inherit" }}
              >
            ...
            {checkboxFields.length > 0 && (
              ...
              >
                ...
                {/* Checkbox 选项列表 */}
                <div className="flex flex-col" style={{ gap: rpx(5) }}>
            ...
            {privacyText && !isGloballyAccepted && (
              ...
              >
                <div
                  className={`flex-shrink-0 border flex items-center justify-center transition-all ${
                    privacyAccepted
                      ...
                      : "border-[#756F3F]/30 bg-transparent"
                  }`}
                  style={{
                    marginTop: rpx(5),
                    width: rpx(24),
                ...
                >
                  {privacyAccepted && (
                    <svg
                      style={{ width: rpx(16), height: rpx(16) }}
            ...
            >
              <span
                className="font-anaheim font-semibold text-center whitespace-pre-line"
                style={{
                  fontSize: rpx(48),
                  lineHeight: rpx(52),
                  color: "inherit",
      ...
      <div className="block md:hidden px-5 py-8">
        ...
        >
          ...
          <div className="relative p-6">
            <h2 className="font-anaheim font-extrabold text-white text-3xl mb-4 whitespace-pre-line">
              {title}
            </h2>
        ...
        <div
          ...
          style={{ backgroundColor: "#FFFFFF", border: "1px solid #cfcaa2" }}
        >
          <h2
            className="font-anaheim font-extrabold text-3xl mb-6"
            style={{ color: "#6F6200" }}
          >
            {configData?.displayName || ""}
          </h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {checkboxFields.map((field) => (
              <div
                ...
                style={{ backgroundColor: "#FBF6E4" }}
              >
                <h3
                  className="font-anaheim font-bold text-lg mb-3"
                  style={{ color: "#6F6200" }}
                >
                  {field.label}
                </h3>
                  ...
                  {field.options?.map((option) => (
                    ...
                    >
                      <div
                        ...
                        style={{
                          border: `1px solid ${(formData[field.fieldName] || []).includes(option.value) ? "#6F6200" : "#9C9667"}`,
                        }}
                      >
