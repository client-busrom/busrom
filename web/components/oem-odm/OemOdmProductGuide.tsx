...
const rpx = (designValue: number) =>
  `calc(var(--rpx-product-guide) * ${designValue * SCALE})`;

// 图片卡片配置 - 3个位置的旋转角度、位置和层级
const cardConfigs = [
  { rotate: -6, left: 120, top: 0, zIndex: 3, opacity: 1, overlay: 0 }, // 最上层
  { rotate: -10, left: 60, top: 0, zIndex: 2, opacity: 1, overlay: 0.15 }, // 中间层
  { rotate: -14, left: 0, top: 0, zIndex: 1, opacity: 1, overlay: 0.35 }, // 最底层
];
    ...
    const fetchProductImages = async () => {
      try {
        const response = await fetch(
          `/api/products?locale=${locale}&pageSize=50`,
        );
        if (response.ok) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ height: rpx(1080) }}
      >
        {/* 居中容器 - 70%宽度居中 */}
        <div className="relative mx-auto h-full" style={{ width: rpx(1920) }}>
          {/* 左上角渐变光晕 */}
          <div
            className="absolute"
            style={{
              ...
              height: rpx(771),
              background:
                "radial-gradient(circle, rgba(255,225,137,0.73) 0%, rgba(255,226,116,0) 100%)",
              filter: "blur(200px)",
            }}
          />
          ...
          <div
            ...
            style={{
              ...
              height: rpx(1305),
              background:
                "radial-gradient(circle, rgba(255,225,112,0.84) 0%, rgba(255,226,116,0) 100%)",
              filter: "blur(200px)",
            }}
          />
                ...
                >
                  {image.enableLink && image.linkUrl ? (
                    <Link
                      ...
                      rel={
                        image.openInNewTab ? "noopener noreferrer" : undefined
                      }
          ...
          >
            ...
            <span
              ...
              style={{
                ...
                color: "transparent",
                background:
                  "linear-gradient(135deg, #756F3F 34%, rgba(219,208,118,0) 100%)",
          ...
          >
            ...
            <circle
              ...
              cy="191.376"
              r="136.283"
              transform="rotate(-51.8011 191.376 191.376)"
              stroke="#D9CEA9"
              strokeWidth="2"
            />
          </motion.svg>
          ...
          {selectedImages[0] && (
            ...
            >
              {selectedImages[0].enableLink && selectedImages[0].linkUrl ? (
                <Link
                  href={selectedImages[0].linkUrl}
                  target={selectedImages[0].openInNewTab ? "_blank" : undefined}
                  rel={
                    selectedImages[0].openInNewTab
                      ? "noopener noreferrer"
                      : undefined
                  }
                  className="block w-full h-full"
