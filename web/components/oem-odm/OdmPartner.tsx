...
export function OdmPartner({
  ...
  return (
    <section
      ...
      style={{
        ["--rpx-odm-partner" as string]: `calc(100vw / ${DESIGN_WIDTH})`,
      }}
    >
      {/* ========== PC端布局 ========== */}
      <div className="hidden md:block relative w-full" style={{ height: rpx(DESIGN_HEIGHT) }}>
        ...
        {/* 标题 - Why Partner with Busrom ODM? */}
        <motion.h2
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                animate={{
                  backgroundColor: isActive ? "#E0D9B8" : "#D9D0B2",
                }}
              ...
              <motion.p
                ...
                animate={{
                  fontSize: isActive ? `calc(var(--rpx-odm-partner) * 24)` : `calc(var(--rpx-odm-partner) * 20)`,
              ...
              <motion.div
                ...
                animate={{
                  backgroundColor: isActive ? "#D0C89A" : "#C0B88A",
                }}
                transition={{ duration: 0.3 }}
              />
            </motion.div>
        ...
        {imageOrder.map((imageIndex, position) => {
          ...
          return (
            <motion.div
              ...
              animate={{
                opacity: 1,
                top: `calc(var(--rpx-odm-partner) * ${config.top})`,
