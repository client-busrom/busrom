...
const rpx = (designValue: number) =>
  `calc(var(--rpx-product-series) * ${designValue})`;
...
interface OemOdmProductSeriesProps {
  // 标题
  title?: string;
  // 描述文字
  description?: string;
...
const defaultContent = {
  ...
  description:
    "Busrom Team is dedicated to providing professional OEM manufacturing and customized solutions for glass hardware to global customers. Its main products include",
};

export function OemOdmProductSeries({
  ...
  return (
    <section
      ...
      style={{
        ["--rpx-product-series" as string]: `calc(100vw / ${DESIGN_WIDTH})`,
      }}
    >
      {/* ========== PC端布局 ========== */}
      <div
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                clipPath: "url(#productSeriesClipPath)",
                WebkitClipPath: "url(#productSeriesClipPath)",
              }}
            >
              {image &&
            ...
            <div
              ...
              style={{
                ...
                WebkitClipPath: "url(#productSeriesClipPath)",
                background:
                  "linear-gradient(to bottom, transparent 20%, rgba(0,0,0,0.68) 100%)",
              }}
            />
      ...
      <div className="block md:hidden px-5 py-8">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <a href={viewMoreLink} className="inline-flex items-center gap-1">
            <span
              className="font-anaheim font-medium text-sm flex items-center gap-1"
              style={{ color: "#C7BB5D" }}
            >
              {viewMoreText}
        ...
        <div className="relative w-full h-[280px]">
          ...
          <svg className="absolute" style={{ width: 0, height: 0 }}>
            <defs>
              <clipPath
                id="productSeriesClipPathMobile"
                clipPathUnits="objectBoundingBox"
              >
                <path
                  transform="scale(0.0008993, 0.001965)"
          ...
          {image && (
            <div
              className="absolute inset-0 w-full h-full"
              style={{
                clipPath: "url(#productSeriesClipPathMobile)",
                WebkitClipPath: "url(#productSeriesClipPathMobile)",
              }}
            >
              {image.enableLink && image.linkUrl ? (
                <Link
...
export default OemOdmProductSeries;
