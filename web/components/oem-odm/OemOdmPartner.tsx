...
// 图片卡片配置 - 3个位置的旋转角度和层级
const cardConfigs = [
  { rotate: -2.4, top: 270, zIndex: 3, shadow: "0 4px 37px rgba(0,0,0,0.33)" }, // 最上层
  { rotate: 5, top: 250, zIndex: 2, shadow: "0 4px 24px rgba(0,0,0,0.26)" },    // 中间层
  { rotate: 11, top: 243, zIndex: 1, shadow: "0 4px 24px rgba(0,0,0,0.26)" },   // 最底层
]
