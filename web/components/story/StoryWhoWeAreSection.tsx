    ...
    >
      ...
      <div className="relative z-10 w-full h-full max-w-[1920px] mx-auto">
        ...
        <motion.div 
          ...
          className="absolute flex items-baseline font-josefin-sans-sans"
          style={{ 
            left: vw(140), 
            top: vw(102),
            gap: vw(16)
        ...
        >
          {data.titleNodes ? data.titleNodes.map((node, idx) => {
            ...
            return (
              <span 
                ...
                style={{
                  ...
                  textShadow: !isBold ? `0 ${vw(4)} ${vw(11)} #565020` : "none",
                }}
              >
                {node.text}
              </span>
            ...
            <span className="text-white text-[80px] font-semibold">Who We Are?</span>
          )}
        </motion.div>
