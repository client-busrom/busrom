  ...
  return (
    ...
    >
      <div className="mx-auto relative h-full" style={{ width: vw(1920) }}>
        ...
        {/* 2. Description - Removed width and set to white-space: pre-line */}
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* 3. CTA Button - Final corrected structure */}
        <motion.div
        ...
        <div
          className="absolute"
          style={{ right: vw(4), top: vw(1), width: vw(520), height: vw(715) }}
        >
          <motion.div
        ...
        {/* 5. Logo - Massive decorative logo according to design specs */}
        <motion.div
          initial={{ opacity: 0 }}
