...
export function ApplicationsSection({ data }: ApplicationsSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* ─── CTA Button (Refactored to match QuoteSection style) ─── */}
      ...
      <div
        className="absolute"
        style={{ left: vw(590), top: vw(33), width: vw(1330), height: vw(800) }}
      >
              ...
              >
                <div className="relative w-full h-full bg-[#D6D3C2] rounded-[vw(60)] overflow-hidden group">
                  <OptimizedImage
                    ...
                    size="large"
                  />
                  {/* Overlay for center item - Limited height gradient at bottom */}
                  {slotIdx === 1 && (
