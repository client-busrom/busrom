...
export function BlogTemplateThree({
  ...
  return (
    <article className="min-h-screen bg-[#fbfcf4] font-montserrat antialiased text-[#000000] pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          >
            <header className="mb-4">
              <h1 className="text-[32px] md:text-[46px] font-bold font-montserrat leading-tight mb-6 text-[#000000]">
                {blog.title}
              </h1>
            ...
            {blog.author && (
              <div className="mt-16 p-8 md:p-12 bg-[#f4f5e6] rounded-[40px] flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
                ...
                <div className="space-y-4">
                  <h4 className="text-2xl font-bold font-montserrat">
                    {typeof blog.author === 'object' ? blog.author?.name : (blog.author || "Busrom Editorial")}
                  </h4>
                  <p className="text-[#000000] leading-tight italic opacity-80">
                  ...
                  <div className="flex justify-center md:justify-start gap-4">
                    <Link
                      href="#"
                      className="text-[11px] font-bold uppercase tracking-widest border-b border-[#000000] pb-1"
                    >
                  ...
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                    {footerCats.categories.map((cat: any) => (
                      <Link
                        ...
                        className="px-6 py-2.5 rounded-full border border-gray-200 text-[11px] font-bold uppercase tracking-widest text-[#000000] hover:border-[#000000] hover:text-[#000000] transition-all"
                      >
                        {cat.name}
                      </Link>
                    ))}
                      ...
                      const renderLink = (item: any, label: string, align: "left" | "right") => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <h4 className="text-xl md:text-2xl font-montserrat font-bold text-[#000000] group-hover:text-[#ff4848] transition-colors leading-tight line-clamp-2">
                              {title || "Read Post"}
                            </h4>
                          </Link>
                        );
              ...
              {showSearch && (
                <div className="relative group">
                  <input
                    ...
                    spellCheck="false"
                    className="w-full bg-white border-2 border-transparent focus:border-[#ff4848]/20 rounded-2xl px-6 py-5 text-sm focus:outline-none shadow-sm placeholder:text-[#000000] transition-all"
                  />
                  <div className="absolute right-6 top-1/2 -translate-y-1/2 text-[#000000] group-focus-within:text-[#ff4848] transition-colors">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 24 24"
                  ...
                  <nav className="space-y-5">
                    {headings.map((h) => (
                      <a
                        key={h.id}
                        href={`#${h.id}`}
                        className={`block text-sm font-bold leading-tight transition-all ${
                          activeId === h.id
                            ? "text-[#ff4848]"
                            : "text-[#000000] hover:text-[#ff4848]"
                        }`}
                    ...
                    {(share.networks && share.networks.length > 0
                      ...
                      return (
                        <a
                          ...
                          className="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center text-[#000000] hover:bg-[#ff4848] hover:border-[#ff4848] hover:text-white transition-all group shrink-0"
                        >
                      ...
                      .map((p: any) => (
                        ...
                        >
                          ...
                          <div className="space-y-1">
                            <h5 className="text-sm font-bold leading-tight group-hover:text-[#ff4848] transition-colors line-clamp-2">
                              {p.title}
                            </h5>
                            <span className="text-[10px] font-bold text-[#000000] uppercase tracking-widest">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {(follow.socials?.length > 0
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center text-[#000000] hover:bg-[#ff4848] hover:border-[#ff4848] hover:text-white transition-all shrink-0"
                      >
      ...
      {showFooterRecommended && footerRec.posts?.length > 0 && (
        <div className="container mx-auto px-6 lg:px-12 mt-24 pt-20 border-t border-gray-100">
          <div className="flex justify-between items-end mb-16">
            <h3 className="text-4xl lg:text-6xl font-montserrat text-[#000000]">
