...
export function ApplicationEngineerSaidSection({
  ...
  return (
    <>
      ...
      <section className="lg:hidden w-full bg-[#FFFDF8] py-16 px-6 md:px-12 flex flex-col items-center gap-10 overflow-hidden select-none">
        {/* Three colored balls */}
        <div className="flex gap-[6px] justify-center">
          <motion.div
            animate={{ y: [0, -10, 0] }}
            transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut" }}
            className="rounded-full shadow-sm w-[18px] h-[18px] bg-[#756F3F]"
          />
          <motion.div
            animate={{ y: [0, -10, 0] }}
            transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut", delay: 0.3 }}
            className="rounded-full shadow-sm w-[18px] h-[18px] bg-[#DAC99E]"
          />
          <motion.div
            animate={{ y: [0, -10, 0] }}
            transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut", delay: 0.6 }}
            className="rounded-full border border-black/10 shadow-sm w-[18px] h-[18px] bg-[#F6F4ED]"
          />
        </div>
        ...
        {mainQuote && (
          <motion.h2
            ...
            className="text-black font-normal text-center text-2xl md:text-4xl leading-relaxed max-w-2xl"
            style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
          {leftQuote && (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="bg-black/[0.02] border border-black/10 rounded-2xl p-6 md:p-8 flex items-center justify-center"
            >
              <p
                className="text-black text-center whitespace-pre-line text-lg md:text-xl leading-relaxed"
        ...
        {/* Visual Center - Title & Masked Images */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-4xl relative">
          {/* Work Image */}
          {workImage && (
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="relative overflow-hidden w-64 h-52 md:w-80 md:h-64 cursor-pointer flex-shrink-0"
              style={{
                maskImage: "url(/images/application/ImageSvg1.svg)",
                maskRepeat: "no-repeat",
                maskSize: "contain",
          ...
          {/* Center Badge (Title) */}
          <div className="flex flex-col items-center justify-center border-2 border-black/70 rounded-[100%/50%] py-8 px-12 bg-[#FFFDF8] z-10 w-64 h-64 shadow-md flex-shrink-0">
            <div className="text-black text-center font-jomhuria" style={{ fontFamily: "Jomhuria, sans-serif" }}>
              <span className="text-4xl leading-tight block">{title.split("\n")[0]}</span>
              {title.includes("\n") && (
                <span className="text-7xl leading-[0.8] block -mt-1">{title.split("\n")[1]}</span>
              )}
            </div>
            {/* Dots */}
            <motion.div
          ...
          {engineerImage && (
            <motion.div
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="relative overflow-hidden w-64 h-64 md:w-80 md:h-80 cursor-pointer flex-shrink-0"
              style={{
                maskImage: "url(/images/application/ImageSvg2.svg)",
                maskRepeat: "no-repeat",
                maskSize: "contain",
        ...
        {ctaText && (
          <Link
            href={ctaHref || "/about"}
            className="group relative flex items-center justify-between bg-black text-white rounded-full pl-6 pr-2 py-2 overflow-hidden w-60 h-14 shadow-md hover:shadow-xl active:scale-95 transition-all mt-4"
          >
            <span className="text-lg font-medium" style={{ fontFamily: "var(--font-anaheim), sans-serif" }}>
              {ctaText}
            </span>
