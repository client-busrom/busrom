        ...
        <div className="text-center mb-10 lg:mb-[3.64vw]">
          <h2
            ...
            dangerouslySetInnerHTML={{
              __html: (title || "Product Related To").replace(/\n/g, "<br />"),
            }}
          />
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 z-0">
                  ...
                  >
                    <path
                      d="M391 0C413.091 0 431 17.9086 431 40V48C431 68.1152 447.052 84.4817 467.045 84.9883L468.955 85.0117C488.948 85.5183 505 101.885 505 122V426C505 448.091 487.091 466 465 466H40C17.9086 466 0 448.091 0 426V40C0 17.9086 17.9086 0 40 0H391Z"
                      fill="white"
                    />
                  </svg>
                </div>
