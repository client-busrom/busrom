...
export function TrustSection({
  ...
  const DescriptionContent = ({ text }: { text: string }) => {
    ...
    return (
      ...
      >
        ...
        `}</style>
        <p
          className="text-[16px] lg:text-[18px] font-medium text-white/80 leading-relaxed pb-4 lg:pr-[40px]"
  ...
  return (
    <section className="relative w-full overflow-hidden flex flex-col items-center bg-black py-32 lg:py-0 min-h-[922px] lg:h-[922px] lg:min-h-[922px]">
      {/* 1. Background Layer */}
          ...
          >
            ...
            {displayItems.map((item, i) => {
              ...
              return (
                <div
                  key={i}
                  className="mb-2 lg:mb-4 group border-b border-white/10"
                >
                  <button
                  ...
                  >
                    ...
                    <div
                      className={`w-8 h-8 lg:w-[40px] lg:h-[40px] rounded-full border-2 flex items-center justify-center transition-all duration-300 shrink-0 ${isExpanded ? "border-[#FFF28E] bg-[#FFF28E] text-black rotate-180" : "border-white/20 text-white"}`}
                    >
                      {isExpanded ? (
                        <Minus
