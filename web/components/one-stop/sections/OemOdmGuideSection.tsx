...
export function OemOdmGuideSection({
  title,
  description,
  bgImage,
  ctaText = "READ MORE",
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center md:items-start px-10 md:pl-[140px] md:pr-[140px] relative -top-[6vw] md:-top-[5vw] z-20">
          <div className="w-full md:w-[900px] mb-12 md:mb-0">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-[#494949] text-[18px] md:text-[28px] font-semibold leading-relaxed md:leading-[50px] text-center md:text-left"
              style={{ fontFamily: "var(--font-anaheim)" }}
            >
              {description ||
                "Busrom's business scope covers 100+ countries, not only has the ability to do OEM/ODM for our wholesalers and dealers, but also offers bespoke plans for designers, builders, and Enterprises."}
            </motion.p>
          </div>
          ...
          <Link
            href={ctaLink}
            className="group flex items-center gap-[15px] self-center md:self-end md:mb-4 transition-all duration-300"
          >
            <span
