  ...
  return (
    ...
    >
      ...
      <div className="hidden md:block relative w-full h-full">
        ...
        >
          <div 
            className="relative h-full flex items-center justify-center transition-transform duration-200 hover:scale-[1.02] hover:animate-[css-shake_0.4s_ease-in-out_infinite]"
            style={{ paddingLeft: rpx(60), paddingRight: rpx(60) }}
          >
            {/* White base layer */}
            <div
              className="absolute inset-0"
            ...
            {/* Button text */}
            <span
              className="font-anaheim font-bold group-hover:scale-105 transition-transform relative z-10 whitespace-nowrap"
              style={{
                fontSize: rpx(60),
                lineHeight: rpx(40),
                color: "#3D3708",
