        ...
        <div className="border-t border-[#627669]/30 pt-10 mb-16">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-8">
            <div className="text-center sm:text-left">
              <h2 className="inline-flex items-center font-lexend-deca text-[16px] font-bold tracking-[0.3em] text-[#060C14] mb-6">
                <span className="w-2 h-2 rounded-full bg-primary mr-4"></span>
                {section.tagTitle || "Selected Articles"}
              </h2>
              {section.introTitle && (
                <h3 className="text-[36px] font-prata !leading-[1.2] mb-6 text-[#060C14]">
                  {section.introTitle}
                </h3>
              )}
              {section.introDesc && (
                <p className="text-[#4E4C3D] font-lexend-deca text-[16px] leading-relaxed font-light tracking-wide max-w-2xl">
                  {section.introDesc}
                </p>
              )}
            </div>
              ...
              >
                ...
                <div className={`lg:col-span-6 p-10 sm:p-16 lg:p-24 text-center lg:text-start ${isRight ? 'lg:order-1' : 'lg:order-2'}`}>
                  <div className="flex flex-col">
                    <h3 className="text-[24px] font-prata text-[#060C14] !leading-[1.2] mb-10 relative z-0 pointer-events-none">
                    ...
                    <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mb-12">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-lexend-deca text-[14px] font-black text-[#060C14] tracking-widest">{item.author?.name || "Admin"}</span>
                      </div>
                    </div>
