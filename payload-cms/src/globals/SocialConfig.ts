      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: { en: 'WeChat', zh: '微信' }, value: 'wechat' },
            { label: { en: 'Weibo', zh: '微博' }, value: 'weibo' },
            { label: { en: 'Douyin', zh: '抖音' }, value: 'douyin' },
            { label: { en: 'Xiaohongshu', zh: '小红书' }, value: 'xiaohongshu' },
            { label: { en: 'Bilibili', zh: 'B站' }, value: 'bilibili' },
