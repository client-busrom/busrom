    ...
    >
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: '20px' }}>
        ...
        <CollapsibleGroup labelKey="websitePages">
          ...
          <NavItem href="/admin/globals/knowledge-base-list-page-config" labelKey="knowledgeBaseListPageConfig" />
        ...
        <CollapsibleGroup labelKey="websiteSettings" defaultOpen={false}>
          ...
          <NavItem href="/admin/globals/waterfall-config" labelKey="waterfallConfig" />
