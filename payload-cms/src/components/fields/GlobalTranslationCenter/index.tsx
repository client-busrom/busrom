...
const TRANSLATABLE_FIELDS: Record<string, TranslatableFieldConfig[]> = {
  'service-features': [
    ...
    { name: 'feature01Title', labelKey: 'Feature 01 - Title', type: 'text' },
    { name: 'feature01ShortTitle', labelKey: 'Feature 01 - Short Title', type: 'text' },
    { name: 'feature01Description', labelKey: 'Feature 01 - Description', type: 'textarea' },
    { name: 'feature02Title', labelKey: 'Feature 02 - Title', type: 'text' },
    { name: 'feature02ShortTitle', labelKey: 'Feature 02 - Short Title', type: 'text' },
    { name: 'feature02Description', labelKey: 'Feature 02 - Description', type: 'textarea' },
    { name: 'feature03Title', labelKey: 'Feature 03 - Title', type: 'text' },
    { name: 'feature03ShortTitle', labelKey: 'Feature 03 - Short Title', type: 'text' },
    { name: 'feature03Description', labelKey: 'Feature 03 - Description', type: 'textarea' },
    { name: 'feature04Title', labelKey: 'Feature 04 - Title', type: 'text' },
    { name: 'feature04ShortTitle', labelKey: 'Feature 04 - Short Title', type: 'text' },
    { name: 'feature04Description', labelKey: 'Feature 04 - Description', type: 'textarea' },
    { name: 'feature05Title', labelKey: 'Feature 05 - Title', type: 'text' },
    { name: 'feature05ShortTitle', labelKey: 'Feature 05 - Short Title', type: 'text' },
    { name: 'feature05Description', labelKey: 'Feature 05 - Description', type: 'textarea' },
  ],
  'brand-advantages': [
    { name: 'advantage01Text', labelKey: 'Advantage 01 - Text', type: 'text' },
    { name: 'advantage02Text', labelKey: 'Advantage 02 - Text', type: 'text' },
    { name: 'advantage03Text', labelKey: 'Advantage 03 - Text', type: 'text' },
    { name: 'advantage04Text', labelKey: 'Advantage 04 - Text', type: 'text' },
    { name: 'advantage05Text', labelKey: 'Advantage 05 - Text', type: 'text' },
    { name: 'advantage06Text', labelKey: 'Advantage 06 - Text', type: 'text' },
    { name: 'advantage07Text', labelKey: 'Advantage 07 - Text', type: 'text' },
    { name: 'advantage08Text', labelKey: 'Advantage 08 - Text', type: 'text' },
    { name: 'advantage09Text', labelKey: 'Advantage 09 - Text', type: 'text' },
  ],
  'why-choose-busrom': [
    { name: 'title', labelKey: 'custom:translationCenter:title', type: 'text' },
    { name: 'title2', labelKey: 'Title 2', type: 'text' },
    { name: 'viewMoreButtonText', labelKey: 'View More Button Text', type: 'text' },
    { name: 'reason01Title', labelKey: 'Reason 01 - Title', type: 'text' },
    { name: 'reason01Description', labelKey: 'Reason 01 - Description', type: 'textarea' },
    { name: 'reason02Title', labelKey: 'Reason 02 - Title', type: 'text' },
    { name: 'reason02Description', labelKey: 'Reason 02 - Description', type: 'textarea' },
    { name: 'reason03Title', labelKey: 'Reason 03 - Title', type: 'text' },
    { name: 'reason03Description', labelKey: 'Reason 03 - Description', type: 'textarea' },
    { name: 'reason04Title', labelKey: 'Reason 04 - Title', type: 'text' },
    { name: 'reason04Description', labelKey: 'Reason 04 - Description', type: 'textarea' },
    { name: 'reason05Title', labelKey: 'Reason 05 - Title', type: 'text' },
    { name: 'reason05Description', labelKey: 'Reason 05 - Description', type: 'textarea' },
  ],
  'quote-steps': [
    { name: 'headerTitle', labelKey: 'Header - Title', type: 'text' },
    { name: 'headerTitle2', labelKey: 'Header - Title 2', type: 'text' },
    { name: 'headerSubtitle', labelKey: 'Header - Subtitle', type: 'text' },
    { name: 'headerDescription', labelKey: 'Header - Description', type: 'textarea' },
    { name: 'step01Text', labelKey: 'Step 01 - Text', type: 'text' },
    { name: 'step02Text', labelKey: 'Step 02 - Text', type: 'text' },
    { name: 'step03Text', labelKey: 'Step 03 - Text', type: 'text' },
    { name: 'step04Text', labelKey: 'Step 04 - Text', type: 'text' },
    { name: 'step05Text', labelKey: 'Step 05 - Text', type: 'text' },
  ],
  'brand-value': [
    { name: 'title', labelKey: 'custom:translationCenter:title', type: 'text' },
    { name: 'subtitle', labelKey: 'custom:translationCenter:subtitle', type: 'text' },
    { name: 'param1Title', labelKey: 'Param 1 - Title', type: 'text' },
    { name: 'param1Description', labelKey: 'Param 1 - Description', type: 'textarea' },
    { name: 'param2Title', labelKey: 'Param 2 - Title', type: 'text' },
    { name: 'param2Description', labelKey: 'Param 2 - Description', type: 'textarea' },
    { name: 'sloganTitle', labelKey: 'Slogan - Title', type: 'text' },
    { name: 'sloganDescription', labelKey: 'Slogan - Description', type: 'textarea' },
    { name: 'valueTitle', labelKey: 'Value - Title', type: 'text' },
    { name: 'valueDescription', labelKey: 'Value - Description', type: 'textarea' },
    { name: 'visionTitle', labelKey: 'Vision - Title', type: 'text' },
    { name: 'visionDescription', labelKey: 'Vision - Description', type: 'textarea' },
  ],
  'simple-cta': [
    { name: 'title', labelKey: 'custom:translationCenter:title', type: 'text' },
    { name: 'subtitle', labelKey: 'custom:translationCenter:subtitle', type: 'text' },
    { name: 'ctaText', labelKey: 'custom:translationCenter:ctaText', type: 'text' },
  ],
  'oem-odm': [
    { name: 'oemTitle', labelKey: 'OEM - Title', type: 'text' },
    ...
    { name: 'odmTitle', labelKey: 'ODM - Title', type: 'text' },
  ...
  'featured-products': [
    ...
    { name: 'viewAllButtonText', labelKey: 'View All Button Text', type: 'text' },
  ],
  'main-form': [
    { name: 'designTextLeft', labelKey: 'Design Text - Left', type: 'text' },
    { name: 'designTextRight', labelKey: 'Design Text - Right', type: 'text' },
  ],
  'case-studies': [
    { name: 'title', labelKey: 'custom:translationCenter:title', type: 'text' },
    { name: 'description', labelKey: 'custom:translationCenter:description', type: 'textarea' },
  ...
  footer: [
    { name: 'formTitle', labelKey: 'Form Title', type: 'text' },
    { name: 'formPlaceholderName', labelKey: 'Name Placeholder', type: 'text' },
    { name: 'formPlaceholderEmail', labelKey: 'Email Placeholder', type: 'text' },
    { name: 'formPlaceholderMessage', labelKey: 'Message Placeholder', type: 'text' },
    { name: 'submitButtonText', labelKey: 'Submit Button Text', type: 'text' },
    { name: 'contactTitle', labelKey: 'Contact Title', type: 'text' },
    { name: 'contactEmailLabel', labelKey: 'Contact Email Label', type: 'text' },
    { name: 'afterSalesLabel', labelKey: 'After Sales Label', type: 'text' },
    { name: 'whatsappLabel', labelKey: 'WhatsApp Label', type: 'text' },
    { name: 'address', labelKey: 'Address', type: 'textarea' },
    { name: 'workingHours', labelKey: 'Working Hours', type: 'text' },
    { name: 'officialNoticeTitle', labelKey: 'Official Notice Title', type: 'text' },
    { name: 'officialNoticeLine1', labelKey: 'Official Notice - Line 1', type: 'text' },
    { name: 'officialNoticeLine2', labelKey: 'Official Notice - Line 2', type: 'text' },
    { name: 'officialNoticeLine3', labelKey: 'Official Notice - Line 3', type: 'text' },
    { name: 'officialNoticeLine4', labelKey: 'Official Notice - Line 4', type: 'text' },
    { name: 'officialNoticeContent', labelKey: 'Official Notice Content', type: 'textarea' },
    { name: 'copyrightText', labelKey: 'Copyright Text', type: 'text' },
  ],
  ...
  'brand-analysis': [
    { name: 'brandNameAnalysis.titlePart1', labelKey: 'Brand Name - Part 1', type: 'text' },
    { name: 'brandNameAnalysis.titlePart2', labelKey: 'Brand Name - Part 2', type: 'text' },
    { name: 'brandNameAnalysis.textPart1', labelKey: 'Brand Name - Text 1', type: 'text' },
    { name: 'brandNameAnalysis.textPart2', labelKey: 'Brand Name - Text 2', type: 'text' },
    { name: 'brandCenter.title', labelKey: 'Brand Center - Title', type: 'text' },
    { name: 'brandCenter.description', labelKey: 'Brand Center - Description', type: 'textarea' },
    { name: 'projectCenter.title', labelKey: 'Project Center - Title', type: 'text' },
    { name: 'projectCenter.description', labelKey: 'Project Center - Description', type: 'textarea' },
    { name: 'serviceCenter.title', labelKey: 'Service Center - Title', type: 'text' },
    { name: 'serviceCenter.description', labelKey: 'Service Center - Description', type: 'textarea' },
  ],
  'email-config': [
    { name: 'emailFromName', labelKey: 'Email From Name', type: 'text' },
    { name: 'autoReplySubject', labelKey: 'Auto Reply Subject', type: 'text' },
    { name: 'autoReplyTemplate', labelKey: 'Auto Reply Template', type: 'textarea' },
  ],
  'site-config': [
    { name: 'siteName', labelKey: 'Site Name', type: 'text' },
    { name: 'siteTagline', labelKey: 'Site Tagline', type: 'text' },
    { name: 'contactAddress', labelKey: 'Contact Address', type: 'textarea' },
    { name: 'defaultMetaTitle', labelKey: 'Default Meta Title', type: 'text' },
