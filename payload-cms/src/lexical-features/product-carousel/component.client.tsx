      ...
      <div style={{ margin: '16px 0', padding: '16px', border: '2px solid #A08745', borderRadius: '8px', backgroundColor: '#ffffff' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600 }}>
            {i18n?.language === 'zh' ? '编辑产品轮播' : 'Edit Product Carousel'}
          </h3>
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '16px' }}>
          <button
            ...
            style={{ display: 'flex', alignItems: 'center', gap: '4px', padding: '8px 12px', backgroundColor: '#3b82f6', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '13px' }}
          >
            <Package size={14} /> {i18n?.language === 'zh' ? '手动选择产品' : 'Manual Select Product'}
          </button>
          <button
            type="button"
            onClick={() => handleAddItem('auto')}
            style={{ display: 'flex', alignItems: 'center', gap: '4px', padding: '8px 12px', backgroundColor: '#10b981', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '13px' }}
          >
            <Shuffle size={14} /> {i18n?.language === 'zh' ? '自动随机产品' : 'Auto Random Product'}
          </button>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '16px' }}>
              ...
              >
                ...
                <div style={{ position: 'absolute', top: '8px', right: '8px', display: 'flex', gap: '4px', zIndex: 10 }}>
                  <button
                    ...
                    style={{ padding: '4px', backgroundColor: '#f3f4f6', color: '#6b7280', border: 'none', borderRadius: '4px', cursor: 'pointer' }}
                ...
                <div style={{ marginTop: '32px' }}>
                  {item.selectionMode === 'manual' ? (
                    product ? (
                      <>
                        ...
                        <button
                          ...
                          style={{ marginTop: '8px', padding: '4px 8px', fontSize: '11px', backgroundColor: '#f3f4f6', color: '#374151', border: 'none', borderRadius: '4px', cursor: 'pointer' }}
                        >
                      ...
                      <button
                        ...
                        style={{ width: '100%', padding: '24px', textAlign: 'center', color: '#6b7280', backgroundColor: '#f9fafb', borderRadius: '4px', border: '1px dashed #d1d5db', cursor: 'pointer', fontSize: '12px' }}
                      >
                    ...
                    series ? (
                      <div style={{ padding: '16px', textAlign: 'center', backgroundColor: '#ecfdf5', borderRadius: '4px', border: '1px solid #a7f3d0' }}>
                        <Shuffle size={20} color="#059669" style={{ marginBottom: '8px' }} />
                        ...
                        <button
                          ...
                          style={{ marginTop: '8px', padding: '4px 8px', fontSize: '11px', backgroundColor: '#d1fae5', color: '#065f46', border: 'none', borderRadius: '4px', cursor: 'pointer' }}
                        >
                      ...
                      <button
                        ...
                        style={{ width: '100%', padding: '24px', textAlign: 'center', color: '#6b7280', backgroundColor: '#f9fafb', borderRadius: '4px', border: '1px dashed #d1d5db', cursor: 'pointer', fontSize: '12px' }}
                      >
                        {i18n?.language === 'zh' ? '点击选择产品系列' : 'Click to select product series'}
                      </button>
                    )
                  )}
                </div>
                ...
                {showItemSettings === index && (
                  <div style={{ marginTop: '12px', padding: '12px', backgroundColor: '#f9fafb', borderRadius: '4px', fontSize: '12px' }}>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '8px', cursor: 'pointer' }}>
                      ...
                      />
                      {i18n?.language === 'zh' ? '新标签打开' : 'Open in New Tab'}
                    </label>
                  </div>
                )}
              </div>
          ...
          {localData.items.length === 0 && (
            <div style={{ gridColumn: 'span 3', padding: '32px', textAlign: 'center', color: '#6b7280', backgroundColor: '#f9fafb', borderRadius: '6px', border: '1px dashed #d1d5db' }}>
              {i18n?.language === 'zh' ? '点击上方按钮添加产品' : 'Click buttons above to add products'}
            </div>
          )}
        </div>
        ...
        <div style={{ padding: '12px', backgroundColor: '#f9fafb', borderRadius: '6px' }}>
          <div style={{ marginBottom: '8px', fontWeight: 600, fontSize: '13px', color: '#374151' }}>
