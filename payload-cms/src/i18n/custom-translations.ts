...
export const customTranslationsEn = {
  custom: {
    ...
    nav: {
      ...
      seriesReusableBlocks: 'Series Blocks',
      productsItem: 'Product Detail Page',
      productAttributes: 'Product Attribute Management',
      productTemplates: 'Product Detail Templates',
      productReusableBlocks: 'Product Detail Blocks',
...
export const customTranslationsZh = {
  custom: {
    ...
    nav: {
      ...
      seriesTemplates: '产品详解页模版',
      seriesReusableBlocks: '产品详解页复用块',
      productsItem: '产品详情整合页',
      productAttributes: '产品详情属性',
      productTemplates: '产品详情页模版',
      productReusableBlocks: '产品详情页复用块',
      categories: '分类',
      blogs: '博客',
      applications: '案例图集',
      pages: '页面',
